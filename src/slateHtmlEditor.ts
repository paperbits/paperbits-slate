...
// import { IHtmlEditor, SelectionState, HtmlEditorEvents, ISelectionPosition } from '../../../app/editing/IHtmlEditor';
// import { IEventManager } from '../../../app/events/IEventManager';
// import { IHyperlink } from "../../permalinks/IHyperlink";
// import { SlateReactComponent } from "./index";

// import * as C from "@paperbits/common/events/IEventManager";

// //var intentions  = 

// export class SlateHtmlEditor implements IHtmlEditor {
//     private slateReactComponent: any;
...
//     public toggleP(): void {
//         this.slateReactComponent.toggleP();
//         this.eventManager.dispatchEvent(HtmlEditorEvents.onSelectionChange);
//     }
...
//     public setHyperlink(data: IHyperlink, selectionPosition?: ISelectionPosition) {
//         this.slateReactComponent.setHyperlink(data, selectionPosition);
//     }
...
//     public resetCategory(intentionFn: string, type: string): void {
//         this.slateReactComponent.resetCategory(intentionFn, type);
//         this.eventManager.dispatchEvent(HtmlEditorEvents.onSelectionChange);
//     }
...
//     public getSelectionPosition(): ISelectionPosition {
//         return this.slateReactComponent.getSelectionPosition();
//     }
//     public setSelectionPosition(selectionPosition: ISelectionPosition, focus: boolean): void {
//         // this.paperSlate.setSelectionPosition(selectionPosition, focus);
//     }

//     public renderToContainer(element: HTMLElement): IHtmlEditor {
//         try {
//             this.slateReactComponent = <IHtmlEditor>this.slateReactComponent.renderToContainer(element);
